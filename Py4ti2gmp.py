...
def minimize(*args, **kwargs):
    ...
    return Py4ti2gmp_cc._minimize(*arguments_list)

def groebner(*args, **kwargs):
    arguments_list = process_function_args(args, kwargs)
    return Py4ti2gmp_cc._groebner(*arguments_list)

def normalform(*args, **kwargs):
    arguments_list = process_function_args(args, kwargs)
    return Py4ti2gmp_cc._normalform(*arguments_list)

def markov(*args, **kwargs):
    arguments_list = process_function_args(args, kwargs)
    return Py4ti2gmp_cc._markov(*arguments_list)

def zbasis(*args, **kwargs):
    arguments_list = process_function_args(args, kwargs)
    return Py4ti2gmp_cc._zbasis(*arguments_list)

def walk(*args, **kwargs):
    arguments_list = process_function_args(args, kwargs)
    return Py4ti2gmp_cc._walk(*arguments_list)

def hilbert(*args, **kwargs):
    arguments_list = process_function_args(args, kwargs)
    return Py4ti2gmp_cc._hilbert(*arguments_list)

def graver(*args, **kwargs):
    arguments_list = process_function_args(args, kwargs)
    return Py4ti2gmp_cc._graver(*arguments_list)

def zsolve(*args, **kwargs):
    arguments_list = process_function_args(args, kwargs)
    return Py4ti2gmp_cc._zsolve(*arguments_list)

def circuits(*args, **kwargs):
    arguments_list = process_function_args(args, kwargs)
    return Py4ti2gmp_cc._circuits(*arguments_list)

def qsolve(*args, **kwargs):
    arguments_list = process_function_args(args, kwargs)
    return Py4ti2gmp_cc._qsolve(*arguments_list)

def rays(*args, **kwargs):
    arguments_list = process_function_args(args, kwargs)
    return Py4ti2gmp_cc._rays(*arguments_list)
